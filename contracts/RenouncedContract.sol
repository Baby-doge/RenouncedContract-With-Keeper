...
contract BabyDogeManager is Ownable, KeeperCompatibleInterface {
    ...
    address public registryAddress = 0x7b3EC232b08BD7b4b3305BE0C044D907B2DF960B;
    ...
    function _exchangeLP() internal {
        if (communityPercent != 0) {
            uint256 communityAmount = (IERC20(lpTokenAddress).balanceOf(
                address(this)
            ) / 10000) * communityPercent;
            IERC20(lpTokenAddress).transfer(communityWallet, communityAmount);
        }
